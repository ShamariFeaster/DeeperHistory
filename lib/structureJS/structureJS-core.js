var structureJS = (typeof structureJS != 'undefined') ? structureJS : {
  ...
  */
  resolveFilePath : function(input, fileExtension){
    ...
    fileExtension = (typeof input === 'string' && input.indexOf('http') != -1) ? '' : fileExtension;
...
(function(){
  ...
  //removing this bc it breaks stuff that has amd loading enabled as we provide no execution of define
